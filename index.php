...
<!-- /****************************************SELECTION D UNE RUBRIQUE**********************************************/ -->
		<div id="rubrique" class="btn-group">
		<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		    Choisissez une rubrique à afficher&nbsp;&nbsp;<span class="caret"></span>
		 </button>
		  <ul class="dropdown-menu">
		  	<li><a href="#" dir="acc">Accueil</a></li>
		    <li><a href="#" dir="sal">Salaires</a></li>
		    <li><a href="#" dir="allo">Allocations</a></li>
		    <li role="separator" class="divider"></li>
		    <li><a href="#" dir="rech">Effectuer une recherche</a></li>
		  </ul>
		</div>
<!-- /****************************************SALAIRES**********************************************/ -->
		<div id="choixSalaire">
...
<!-- /****************************************RECHERCHE**********************************************/ -->
		...
		<div id="dialog-confirm" title="Confirmation*">
		  	<p><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span>Etes-vous sur de vouloir supprimer cette allocation ?</p>
		</div>
	</body>
</html>